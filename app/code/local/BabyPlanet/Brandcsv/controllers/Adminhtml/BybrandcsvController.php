...
class BabyPlanet_Brandcsv_Adminhtml_BybrandcsvController extends Mage_Adminhtml_Controller_Action {

    protected function _initAction() {
        $this->loadLayout()
            ->_setActiveMenu('Brandcsv/items')
	...
	public function brandcsvSelectedOrdersAction() {
		...
		foreach ($orderIds as $orderId) {
			...
			foreach($items as $item) {
				...
				if ( $brand == $product->getAttributeText('seller')) {
